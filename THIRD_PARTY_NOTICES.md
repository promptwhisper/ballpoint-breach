...
Source: https://github.com/google/fonts/tree/main/ofl/longcang at commit
`5e35378e6bda803962ee6fd257e444a7d459660d`. Licensed under the SIL Open Font
License 1.1. The runtime build uses a renamed WOFF2 subset under the internal
family name `BB Ink Display`. The complete license is preserved at
`licenses/fonts/LongCang-OFL-1.1.txt`.

## LXGW WenKai

Source: https://github.com/lxgw/LxgwWenKai at commit
`50f4b182415a8c33d9a456df220b66a284e2509b`. Licensed under the SIL Open Font
License 1.1. The runtime build uses renamed Latin and CJK WOFF2 subsets under
the internal family name `BB WenKai UI`. The complete license is preserved at
